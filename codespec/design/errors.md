...
| Transport | NETWORK, NETWORK_TIMEOUT, HTTP_RETRY_EXHAUSTED, RATE_LIMIT, HTTP_STATUS, GIT_UNAVAILABLE, GIT_FAILED, GIT_TIMEOUT, GIT_PROTOCOL, REVISION_AMBIGUOUS, PROCESS |
